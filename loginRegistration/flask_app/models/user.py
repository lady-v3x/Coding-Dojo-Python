...
class User:
    ...
    def newUser(cls, data):
        query="INSERT INTO users (firstName, lastName, bday, email, pw, pwConfirm, createdAt, updatedAt) VALUES (%(firstName)s, %(lastName)s, %(bday)s, %(email)s, %(pw)s, %(pwConfirm)s, NOW(), NOW());"
